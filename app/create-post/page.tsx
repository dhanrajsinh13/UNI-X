      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-sm max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <button
              onClick={() => router.push('/')}
              className="bg-[#FFAF50] text-black px-6 py-3 rounded-full font-semibold hover:bg-orange-500 transition-colors"
            >
              Go to Homepage
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pb-20 md:pb-8">
      ...
      <div className="max-w-2xl mx-auto px-4 py-4 md:py-8">
        ...
        <div className="mb-4 md:mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="md:hidden px-4 py-2 bg-[#FFAF50] text-black font-semibold rounded-full hover:bg-orange-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 text-sm"
            >
        ...
        <div className="bg-white rounded-xl md:rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <form onSubmit={handleSubmit}>
            ...
            <div className="p-4 md:p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-[#FFAF50] to-orange-400 rounded-full flex items-center justify-center text-white font-bold shadow-md">
            ...
            <div className="p-4 md:p-6">
                  ...
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`p-3 md:p-4 rounded-xl border-2 transition-all text-sm font-medium relative overflow-hidden group ${category === cat.id
                        ? 'border-[#FFAF50] bg-gradient-to-br from-[#FFAF50]/20 to-orange-100 shadow-md scale-105'
                    ...
                    >
                      ...
                      {category === cat.id && (
                        <div className="absolute top-2 right-2">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20 6L9 17L4 12" stroke="#FFAF50" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </div>
                      )}
                    </button>
              ...
              <div className="mb-6">
                <label className={`flex items-center justify-center gap-3 px-6 py-4 border-2 border-dashed rounded-xl cursor-pointer transition-all group ${mediaPreview
                  ? 'border-[#FFAF50] bg-[#FFAF50]/5'
                  : 'border-gray-300 hover:border-[#FFAF50] hover:bg-gray-50'
                  }`}>
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg transition-colors ${mediaPreview
                      ? 'bg-[#FFAF50] text-white'
                      : 'bg-gray-100 text-gray-600 group-hover:bg-[#FFAF50] group-hover:text-white'
                      }`}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="hidden md:flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  disabled={!caption.trim() || isSubmitting}
                  className="px-8 py-3 bg-gradient-to-r from-[#FFAF50] to-orange-400 text-black font-semibold rounded-full hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 flex items-center gap-2"
                >
                  {isSubmitting ? (
                    <>
        ...
        {/* Tips Section */}
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-orange-50 rounded-xl p-4 border border-blue-100">
