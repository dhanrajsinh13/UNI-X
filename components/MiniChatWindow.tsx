...
const MiniChatWindow: React.FC<MiniChatWindowProps> = ({ isOpen, onClose, otherUser }) => {
  ...
  return (
    <>
      ...
      {/* Mini Chat Window */}
      <div className={`fixed bottom-4 right-4 bg-white rounded-lg shadow-xl z-50 flex flex-col border border-gray-200 animate-in slide-in-from-bottom-2 duration-300 ${
